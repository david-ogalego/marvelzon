...
test('Snapshot ComicDetail rendered with comic', () => {
    const treeComicDetail = renderer.create(<ComicDetail
        ...
        url={'http://marvel.com/comics/issue/2088/official_handbook_of_the_marvel_universe_2004_14_fantastic_four/fantastic_four?utm_campaign=apiRef&utm_source=d86beaee5f52cf5b1205630a7e35b24b'} />).toJSON();
